...
private List<Point> coordenadasProhibidas; 
public Tablero5() {
initComponents();
this.setSize(900, 920);
this.setLocationRelativeTo(null);
this.setTitle("Tablero");
coordenadasProhibidas = new ArrayList<>();
...
// Agrega aquí la lógica para mover la ficha
  ...
  // Método para obtener la coordenada x de un botón
    private int getXCoordinate(JButton button) {
        return (button.getX() - jPanel1.getX()) / button.getWidth();
    }

    // Método para obtener la coordenada y de un botón
